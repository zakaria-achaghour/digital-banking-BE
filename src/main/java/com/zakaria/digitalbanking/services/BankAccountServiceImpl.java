...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    @Override
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, UUID customerId) throws CustomerNotFoundException {
    ...
    @Override
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, UUID customerId) throws CustomerNotFoundException {
        Customer customer=customerRepository.findById(customerId).orElse(null);
        if(customer==null)
            throw new CustomerNotFoundException("Customer not found");
    ...
    @Override
    public BankAccountDTO getBankAccount(UUID accountId) throws BankAccountNotFoundException {
    ...
    @Override
    public void transfer(UUID accountIdSource, UUID accountIdDestination, double amount) throws BankAccountNotFoundException, BalanceNotSufficientException {
    ...
    @Override
    public List<AccountOperationDTO> accountHistory(UUID accountId) {
    ...
    public AccountHistoryDTO getAccountHistory(UUID accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        Page<AccountOperation> accountOperations = accountOperationRepository.findByBankAccountIdOOrderByDateOperationDesc(accountId, PageRequest.of(page, size));
